...
export class AdminService {
  ...
  fetchAllCourses() {
    return this.httpClient.get(this.url + '/admin/courses/all')
  }
  fetchVerifiedCourses() {
    return this.httpClient.get(this.url + '/admin/courses/verified')
  }
  fetchVerificationPendingCourses() {
    return this.httpClient.get(this.url + '/admin/courses/pending')
  }
  fetchUnderVerificationCourses() {
    return this.httpClient.get(this.url + '/admin/courses/verifing')
  }

  getCourse(id: string) {
    return this.httpClient.get(this.url + '/admin/courses/' + id)
  }
